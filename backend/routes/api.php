...
use App\Modules\Cart\Controller\CartGetController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum'])->group(function () {
        Route::prefix('cart')->group(function () {
            ...
            Route::get('{id}', CartGetController::class)->name(RouteNameEnum::ApiCartGet);
            Route::put('{id}', CartUpdateController::class)->name(RouteNameEnum::ApiCartUpdate);
            Route::delete('{id}', CartDeleteController::class)->name(RouteNameEnum::ApiCartDelete);
        });
    });
});
